		<div class="footer">
			<div class="footer1"><img src="img/EPA%20rogné.png"></div>
			<div class="col f2 footer2">
			...
			<div class="f3">
				...
				<div><a href="#">Mentions légales et CGU</a></div>

			</div>
			<div class="col footer4">
				<div class="f4">
					<a href="mailto:greendow.epa@gmail.com">Nous contacter</a>
				</div>
			</div>
			<div class="footer5">
