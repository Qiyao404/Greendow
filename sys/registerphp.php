<?php
	...
	if(!empty($_POST)){
		...
		if(!isset($_POST['email']) || empty($_POST['email']) || !filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)){
			$_SESSION['error'][] = "Veuillez rentrer un e-mail valide";
		} elseif($_POST['email'] !== $_POST['c_email'] && isset($_POST['c_email']) && !empty($_POST['c_email'])){
			$_SESSION['error'][] = "Les e-mails sont différents";
		} elseif(!isset($_POST['c_email']) || empty($_POST['c_email'])){
			$_SESSION['error'][] = "Veuillez confirmer votre e-mail";
		} else{
		...
		if(!isset($_POST['password']) || empty($_POST['password'])){
			...
			} elseif($_POST['password'] !== $_POST['c_password'] && isset($_POST['c_password']) && !empty($_POST['c_password'])){
