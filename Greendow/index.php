...
<body>
	<!-- <div class="top-nav">
		<div class="container clearf">
			<div class="fl"><a href="tryindex.html"><img src="img/Capture_d_écran_2021-09-29_à_11.34.09-removebg-preview.png" style="height: 80px;"></a>
			</div>
			<div class="fl">
	...
	<div class="pourquoi" id="pourquoi">
	...
	<div class="footer">
		<div class="footer1"><input type="image" src="./img/EPA%20rogné.png" style="height:200px;margin:35px 0 0 -30px" /></div>
		<div class="col-f f2">
		...
		<div class="col-f f3">
			<img src="img/Capture_d_écran_2021-09-29_à_11.34.09-removebg-preview.png" style="height:130px;margin:40px 0 0 40px">
		</div>
	</div>
