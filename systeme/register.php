...
<form action="registerphp.php" class="Inscription" method="post">
	...
	<input type="email" class="entrer" placeholder="Adresse mail" name="email"/>
	<input type="email" class="entrer" placeholder="Confirmez adresse email" name="c_email"/>
	...
	<div><a href="login.php" id="compte">
